...
object Graph {
  def main(args: Array[String]): Unit = {
    ...
    val trips_df = spark.read
      ...
      .load("C:\\Users\\sarik\\PycharmProjects\\BDP_ICP12\\trip_data.csv")
    ...
    val station_df = spark.read
      ...
      .option("header", "true") //reading the headers
      .option("mode", "DROPMALFORMED")
      .load("C:\\Users\\sarik\\PycharmProjects\\BDP_ICP12\\station_data.csv")
    ...
    stationGraph.vertices.write.csv("j.csv")

    stationGraph.edges.write.csv("i.csv")
